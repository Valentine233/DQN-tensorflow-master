...
class VirtualUserConfig(object):
  ...
  nb_img = 100  # nb of image
  rel_max = 100  # non-relevancy max
  top_nb = 7  # chosen nb of top images
  rad_nb = 2  # chosen nb of random images
  LOW = -2
  MIDDLE = 4
  HIGH = 10
  action_size = 4  # nb of actions

class DQNConfig(AgentConfig, VirtualUserConfig):
  model = ''
  pass
